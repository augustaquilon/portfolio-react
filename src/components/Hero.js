...
import Background from 'assets/images/cool-background (blue).png';

const Hero = () => {
  return (
    <section className="header-and-logo">
      <section className="logo-container">
        <img src={Background} alt="background" />
      </section>
      <header>
        <section className="hero">
          <section className="headshot1-container">
        ...
        <section className="icons-container">
          <a className="a-container" href="https://www.linkedin.com" target="_blank" rel="noreferrer">
            <svg className="svg linkedin" width="42" height="42" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <a className="a-container" href="https://www.github.com" target="_blank" rel="noreferrer">
            <svg className="svg github" width="43" height="42" viewBox="0 0 33 32" fill="none" xmlns="http://www.w3.org/2000/svg">
