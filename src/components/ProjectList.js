...
export const projectList = [
  {
    ...
    description: 'Dive into the captivating world of  “A Manatee Imagines A Butterfly” through this 3D Dora website. It is a synesthetic fusion of sight and sound, where the ethereal melodies of Leonard Malmer’s music intertwine with beautiful visuals generated by Nino.',
    tech: ['DORA', 'MIDJOURNEY'],
  ...
  },
  {
    ...
    tech: ['HTML', 'CSS', 'JS', 'API', 'REACT', 'EXPRESS', 'MONGO', 'NODE'],
