...
export const projectList = [
  ...
  },
  {
    ...
    img: '',
    alt: 'picture of computer',
    description: 'A website showing the latest movie releases, built with React. Data fetched from a public API.',
  ...
  },
  {
    ...
    img: '',
    alt: 'picture of computer',
    description: 'A text-based labyrinth game using Redux for state-management. Careful, or you might get lost!',
    tech: ['React', 'Redux'],
  ...
  },
  {
    ...
    img: '',
    alt: 'picture of computer',
    description: 'An accessible music survey built with React, with input validation as well as custom radio buttons and checkboxes. ',
  ...
  },
  {
    ...
    img: '',
    alt: 'picture of computer',
    description: 'The latest album and single releases on Spotify, gathered in one place. Built with React while pair-programming in teams of two.',
    tech: ['HTML', 'CSS', 'JavaScript', 'API', 'React', 'Pair-Programming'],
  ...
  },
  {
    ...
    img: '',
    alt: 'picture of computer',
    description: 'My version of a Guess Who-game, built with Vanilla JS.',
  ...
  },
  {
    ...
    img: '',
    alt: 'picture of computer',
    description: 'My version of a chatbot, built with Vanilla JS.',
    tech: ['HTML', 'CSS', 'JavaScript'],
